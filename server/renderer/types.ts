...
export type WidgetOptionsById<Id extends WidgetId> = WidgetRegistry[Id] extends Widget<infer Options, any> ? Options : never;
export type WidgetPropsById<Id extends WidgetId> = WidgetRegistry[Id] extends Widget<any, infer Props> ? Props : never;
